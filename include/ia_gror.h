#ifndef MICROG_IA_GROR_H
#define MICROG_IA_GROR_H
#pragma once
/**=====================================================================================================
...
namespace pcl {
    namespace registration
    {
        ...
        public:
            ...
            typedef shared_ptr<GRORInitialAlignment<PointSource, PointTarget, Scalar> > Ptr;
            typedef shared_ptr<const GRORInitialAlignment<PointSource, PointTarget, Scalar> > ConstPtr;
            ...
            */
            void
            get_edge_InlierCorrespondences(CorrespondencesPtr &correspondences) { correspondences = inliers_; };
            void
            get_node_InlierCorrespondences(CorrespondencesPtr &correspondences) { correspondences = output_correspondences_nodes;};
            ...
            */
            ...
            void
            getInputSource_clearRudent (PointCloudSourcePtr &Source_clearRudent) { Source_clearRudent=key_source_ ; }
            void
            getInputTarget_clearRudent (PointCloudTargetPtr &Target_clearRudent) { Target_clearRudent=key_target_ ; }
...
//			CorrespondencesPtr output_correspondences_;
            ...
            /** \brief The output correspondences. */
            CorrespondencesPtr output_correspondences_;
            CorrespondencesPtr output_correspondences_nodes;
